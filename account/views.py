    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if password1 and password2 and password1 != password2:
               messages.add_message(request, messages.ERROR, 'رمز اول با رمز دوم برابر نیست!!!!')

        else:
            messages.add_message(request, messages.ERROR, 'متاسفانه ثبت نام انجام نشد. مجددا امتحان کنید.')
            print(form.errors)
                # return redirect('home')
        # else:
        #     print(form.errors)
